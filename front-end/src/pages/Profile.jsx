            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`block w-full text-center py-2 px-4 rounded transition ${
                    activeTab === "orders"
                      ? "bg-black text-white"
              ...
              <button
                onClick={handleLogout}
                className="w-full mt-4 bg-red-500 text-white py-3 px-4 rounded hover:bg-red-600 transition"
              >
                Logout
              </button>
            </div>
...
<div className="w-full md:w-2/3 lg:w-3/4">
  <div className="bg-white shadow-md rounded-lg p-6">
    {activeTab === "orders" ? (
      <>
        <h2 className="text-2xl font-bold mb-6">Recent Orders</h2>
        <MyOrdersPage initialTab="orders" />
      </>
    ) : (
      <>
        <h2 className="text-2xl font-bold mb-6">Settings</h2>
        <MyOrdersPage initialTab="settings" />
      </>
    )}
    <button
